...
void APlayerControllerBase::ShowDamageText_Implementation(float Damage, ACharacter* TargetCharacter)
{
	if (IsValid(TargetCharacter))
	{	
		UDamageTextComponent* DamageTextComponent = NewObject<UDamageTextComponent>(GetPawn(),DamageTextComponentClass);
